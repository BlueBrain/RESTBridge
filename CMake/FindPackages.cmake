...
if(cppnetlib_name)
  ...
  if(NOT "${${cppnetlib_name}_INCLUDE_DIR}" MATCHES "-NOTFOUND")
    include_directories(SYSTEM ${${cppnetlib_name}_INCLUDE_DIR})
  endif()
endif()
...
if(Servus_name)
  list(APPEND FIND_PACKAGES_DEFINES RESTBRIDGE_USE_SERVUS)
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND RESTBRIDGE_DEPENDENT_LIBRARIES Servus)
  endif()
...
set(RESTBRIDGE_BUILD_DEBS autoconf;automake;avahi-daemon;cmake;doxygen;git;git-review;libavahi-client-dev;libboost-program-options-dev;libboost-system-dev;libboost-test-dev;libboost-thread-dev;libzmq3-dev;pkg-config;subversion)

set(RESTBRIDGE_DEPENDS Boost;cppnetlib;Servus;zeq;FlatBuffers)
