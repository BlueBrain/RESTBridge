...
common_package(Boost 1.41.0 COMPONENTS unit_test_framework program_options system thread QUIET)
...
common_package(zeq   QUIET)
if(NOT zeq_FOUND AND NOT ZEQ_FOUND)
  set(FIND_REQUIRED_FAILED "${FIND_REQUIRED_FAILED} zeq")
endif()
common_package(FlatBuffers   QUIET)
